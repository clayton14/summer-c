...
employee emp[LOT_SIZE] = {
    {.clock_number = 98401, .wage_rate = 10.60},
    {.clock_number = 526488, .wage_rate = 9.75},
    {.clock_number = 765349, .wage_rate = 10.50},
    {.clock_number = 034645, .wage_rate = 12.25},
    {.clock_number = 127615, .wage_rate = 8.35},
